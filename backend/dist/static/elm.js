...
var $author$project$Types$GetScoreAndName = {$: 8};
var $author$project$Types$IdInput = function (a) {
	return {$: 9, a: a};
};
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Types$GetScoreAndName)
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('get state')
							]))
					])),
				A2(
				$elm$html$Html$div,
